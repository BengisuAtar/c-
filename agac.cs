...
public class Agac
{
    ...
    {
        Agac agac = new Agac();
        agac.Kök = new Dugum(3);
        agac.Kök.Sol = new Dugum(7);
        agac.Kök.Sag = new Dugum(9);
        agac.Kök.Sol.Sol = new Dugum(2);
        agac.Kök.Sol.Sag = new Dugum(5);
        agac.Kök.Sag.Sol = new Dugum(8);
        agac.Kök.Sag.Sag = new Dugum(1);
